...
#
debugLevel0 = False  # Data og Info
debugLevel1 = False  # Info/warnings
debugLevel2 = False  # Criticalwarning/error
debugLevel3 = False  # Security data, normally not to be displayed
netAtmoJsonData = True  # Set True if you want the NetAtmo data logged to file
netAtmoRunningCatalogue = "/home/pi/Documents/"
accountFile = netAtmoRunningCatalogue + 'account.json'
...
def generateNetAtmoToken(tokenFileName, netAtmoTokenURL, netAtmoAccoungJsonData):
    ...
    payload = {'grant_type': 'password',
               'username': netAtmoAccoungJsonData['username'],
               'password': netAtmoAccoungJsonData['password'],
...
def initNetAtmo(tokenData, netAtmoDeviceID):
    ...
    try:
        ...
        tmp = """{
            ...
            "username"     : "netatmouser@yourdomain.com",
            "password"     : "*****",
    ...
    netAtmoPassword = hash_password(netAtmoAccoungJsonData['password'])
    ...
    if debugLevel3:
        print('Debug level3:\nAccount binary data:\n{}\n'.format(data))
    if debugLevel2:
        print('Debug level2:\nclient_id:{}\nclient_secret:{}\nusername:{}\npassword (encrypted):{}****\ndevice_id:{}\n'.format(netAtmoDeviceID,
                                                                                                                               netAtmoAccoungJsonData['client_secret'], netAtmoAccoungJsonData['username'], netAtmoPassword[0:5], netAtmoAccoungJsonData['device_id']))
    if debugLevel1:
        print('Debug level1:\nNetAtmo initialization done')

    # Now, token data is needed
    try:
        ...
        if debugLevel1:
            print(
                'Debug level1:\nWarning.\n{}.Token file will be generated.'.format(fnf_error))
